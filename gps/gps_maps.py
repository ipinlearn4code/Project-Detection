...
async def get_gps_async(timeout=10):
    ...
    try:
        ...
        try:
            ...
            logger.warning("GPS: Timeout tercapai, gagal mendapatkan posisi.")
        ...
        logger.error(f"GPS: Error pada serial port: {e}")
...
# contoh main untuk coba read gps signal secara langsung
async def main():
